...
>({
	...
	const date =
		data.isStock && data.isStock === true && data.validUntil !== 'Invalid date'
			? data.validUntil
		...
		<div className={cl.cardPost}>
			...
			<div className={cl.cardPostInfo}>
				...
				{/* {data.description && data.description !== '' && (
					<div className={cl.cardPostInfoDesc}>{data.description}</div>
				)} */}
				{tags && (
					<ul className={cl.cardPostTags}>
						{tags.map((item, index) => (
							<li className={cl.cardPostTagsItem} key={index}>
								{item}
							</li>
						))}
					</ul>
				...
				{(data.workDesc || data.validUntil) && (
					<div className={cl.cardPostInfoWorkDesc}>
						<span className={cl.cardPostIcon + ' ' + cl.cardPostIconPadding}>
							<svg
								width="16"
								height="16"
								viewBox="0 0 16 16"
						...
						<span className={cl.cardPostIcon}>
							...
							>
								<path
									fillRule="evenodd"
									clipRule="evenodd"
									d="M4 2H2V3H4V9H2V10H4V12H2V13H4V15H5V13H11V12H5V10H10C12.2091 10 14 8.20914 14 6C14 3.79086 12.2091 2 10 2H5H4ZM5 3V9H10C11.6569 9 13 7.65685 13 6C13 4.34315 11.6569 3 10 3L5 3Z"
									fill="#6A6A6A"
								/>
							</svg>
						</span>
