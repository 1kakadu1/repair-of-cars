		...
		<div className={cl.cardProduct}>
			<Link href={RoutsPath.product + '/' + product.slug}>
				<a className={cl.cardProductPreviewContainer}>
					<div
						className={
							cl.cardProductCounter +
							' ' +
							(count > 0 ? cl.cardProductCounterActive : '')
						}
					>
						{count}
					</div>
			...
			<div className={cl.cardProductContent}>
				...
				<div className={cl.cardProductBody}>
					<Link href={RoutsPath.product + '/' + product.slug}>
						<a className={cl.cardProductBodyTitle}>{product.name}</a>
					</Link>
					...
					<div className={cl.cardProductActions}>
						...
						{isFavorite !== undefined && onFavorite && (
							<ButtonDefault
								...
								className={
									cl.cardProductActionFavorite +
									' ' +
									(isFavorite ? cl.cardProductActionFavoriteActive : '')
								}
							>
								<HeartIcon />
							</ButtonDefault>
