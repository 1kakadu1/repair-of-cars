                ...
                <div className={styles.footerMenuRow}>
                    ...
                    <div className={styles.footerInfo}>
                        <a className={styles.footerPhone} href={`tel: ${phones[0].href}`}>
                            {phones[0].label}
                            <span className={styles.footerPhoneTitle}>
                                Звонок бесплатный
                            </span>
                        </a>
                    ...
                    <div className={styles.footerMenu + " " + styles.footerMenuHide}>
                        <ListItems
                            title="Компания"
                            items={menuMock[2]?.subMenu?.map(item=>({name: item.name, href: item.href})) || []}
                        />
                    </div>
