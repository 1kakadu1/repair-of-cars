			...
			<Container>
				...
				<Wrapper color="#F8F8F8">
					...
					<p>
						...
						Магазин шин Колеса Даром в Саранске поможет вам сделать его легким и
						быстрым. Существующие типы (зимние шины, летние шины и внедорожные)
						различаются по составу резиновой смеси, конструкции и дизайну
						протектора. Именно от рисунка покрышки зависит ее износ,
					...
					<p>
						...
						износостойкость покрышек. Но эта резина абсолютно не подходит для
						зимы - она замерзает, твердеет и скользит на ледяной дороге. При ее
						производстве должны использоваться технологии, защищающие диск и
						ходовую часть при ударах и уменьшающие тормозной путь. Шины зимние
						имеют более рельефный рисунок (так называемые шины-липучки или шипы
						для безопасной езды по льду. Они остаются мягкими при отрицательной
						температуре благодаря оптимальному химическому составу резиновой
						смеси.
					</p>
					<p>
						...
						приятные цены сделают процесс выбора еще более увлекательным. Подбор
						шин по марке автомобиля, например, позволяет без лишних усилий
						(выбрав только марку своего авто) сделать запрос, после чего система
						предоставит все возможные варианты покрышек, максимально подходящие
						вашей машине. Сравнив характеристики и цены, вы сможете сделать
						осознанный и правильный выбор.
					</p>
				</Wrapper>
				<Box styles={{ paddingTop: '20px' }} />
			</Container>
